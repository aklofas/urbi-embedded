...
| .chk total fixture count | n/a | 304 total (288 non-repl active, 16 REPL-gated) | `find tests/chk -name '*.chk' \| wc -l` | 2026-05-27 | **passing-evidence** (informational) — bumped from 284 baseline as Cat. E ratification arc activates new fixtures (v0.10.9 +6, v0.10.10 +6, v0.10.11 +8) |
