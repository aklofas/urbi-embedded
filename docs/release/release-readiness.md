...
|---|---|---|---|---|---|
| .chk pass rate (active fixtures) | ≥95% | 100% (281/281) | `make test-chk` — 281 fixtures, 0 failures | 2026-05-27 | **passing-evidence** |
| .chk total fixture count | n/a | 296 total (281 non-repl active, 15 REPL-gated) | `find tests/chk -name '*.chk' \| wc -l` | 2026-05-27 | **passing-evidence** (informational) — bumped from 284 baseline as Cat. E ratification arc activates new fixtures (v0.10.9 +6, v0.10.10 +6) |
