...
static struct { const char *name; struct UObject *proto; } g_protos[UROS_MSG_MAX];  /* audit-globals-allow: process-global msg-proto cache; per-VM relocation is v0.13.4-ros-hardening scope */
static int g_protos_n;  /* audit-globals-allow: cross-VM proto cache — moves onto UVM at v0.13.4 */
