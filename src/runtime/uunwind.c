...
urbi_unwind(UStrand *s)
{
    ...
    while (s->cleanup_depth > 0) {
        ...
        case UCLEANUP_TRY_FRAME: {
            ...
            /* Catch-all: any throw matches any catch clause (v1.0 behavior;
             * class-pattern dispatch is a v1.x extension — see the
             * pattern_matches definition above).  cppcheck flags the
             * tautological condition — suppressed file-wide in
