...
#include "stdlib/object_root.h"       /* urbi_raise_typed (v0.11.4) */
#include "urbi/urbi.h"                /* urbi_throw (v0.11.4) */

/* slot_throw_or_fatal — v0.11.4: shared deposit for the 6 slot-access error
