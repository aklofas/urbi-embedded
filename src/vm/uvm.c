...
#include "sched/usched_cooperative.h" /* sched_strand_init, sched_walk_roots (uvm_run) */
#include "runtime/uunwind.h"
#include "realm/urealm.h"             /* URealm, urbi_realm_global (OP_LOAD_REALM_GLOBAL + uvm_run) */
#include "urbi/gc.h" /* urbi_gc_slice + URBI_GC_SLICE_BUDGET */
#include "tag/utag.h"    /* UTag, utag_create/destroy (T30) */
#include "watcher/uwatcher.h"          /* UWatcher, watcher_table_walk_roots (T32) */
...
#include "object/umodule_instance.h" /* urbi_module_instance_create (uvm_run) */
