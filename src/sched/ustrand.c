...
{
    /* Native closures carry proto == NULL; arming them would crash at the
     * instructions deref below.  Reject before register-stack allocation
     * to avoid a GC-managed alloc with no paired free. */
